...
@RequestMapping("/api/student")//映射路径

public class StudentController {
    private final StudentService studentService;//注入StudentService
    ...
    @PostMapping("/getStudentList")//映射路径
    ...
    public ResponseEntity<StreamingResponseBody> getStudentListExcl(@Valid @RequestBody DataRequest dataRequest) {//映射路径
        return studentService.getStudentListExcl(dataRequest);//返回Excl文件
    }
    ...
    public DataResponse getStudentPageData(@Valid @RequestBody DataRequest dataRequest) {
        return studentService.getStudentPageData(dataRequest);//返回分页数据，返回分页数据，包含分页信息，和数据列表
    }
    ...
    public DataResponse uploadPhoto(@Valid @RequestBody DataRequest dataRequest) {
        return studentService.uploadPhoto(dataRequest);
    }
