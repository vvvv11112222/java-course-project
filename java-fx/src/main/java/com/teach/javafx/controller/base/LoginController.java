...
//        loginButton.setStyle("-fx-background-color: red; -fx-text-fill: white;");
    ...
    public void onButtonHover() {
        loginButton.setStyle("-fx-background-color: #3a76d8; -fx-text-fill: white; -fx-font-size: 16px; -fx-padding: 10; -fx-background-radius: 5; -fx-cursor: hand;");
    }

    @FXML
    public void onButtonExit() {
        loginButton.setStyle("-fx-background-color: #4a86e8; -fx-text-fill: white; -fx-font-size: 16px; -fx-padding: 10; -fx-background-radius: 5; -fx-cursor: hand;");
    }
}